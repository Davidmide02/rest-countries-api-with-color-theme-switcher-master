...
The challenge is to build the design to look closely to the design with interactivity
...
- [Tailwindcss](https://tailwincss.com/) - For styles
...
- useContext
- useReducer
use the above react hooks to simplify the states.
